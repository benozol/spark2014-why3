  ...
  if not Gnat_config.giant_step_rac then None else (
    ...
    | Some loc ->
        ...
        | Some rs ->
            ...
            (*      failwith "giant-step RAC failed in loop invariant initialisation" *)
            (*  | _ -> ()); *)
            Some res )
...
let _ =
  ...
  List.iter Introduction.push_attributes_with_prefix
    ["GP_Check:"; "GP_Pretty_Ada:"; "GP_Shape:";
